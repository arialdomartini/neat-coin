...
namespace NeatCoin
{
    internal class Block
    {
        ...
        internal Block(ICryptography cryptography, DateTimeOffset createdAt, ImmutableList<Transaction> transactions, string parent, int nonce)
        {
        ...
        internal bool MatchesDifficulty(int difficulty) =>
